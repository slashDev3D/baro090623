...
<link rel="stylesheet" href="<?php echo G5_URL ?>/common/css/font.css?ver=<?php echo G5_CSS_VER ?>">
<link rel="stylesheet" href="<?php echo G5_URL ?>/common/css/layout.css?ver=<?php echo G5_CSS_VER ?>">
<?php
...
add_javascript('<script src="'.G5_URL.'/common/js/common.js"></script>', 0);
if(G5_IS_MOBILE) {
