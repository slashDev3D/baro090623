...
if ($w == "") {
    ...
    // if (!isset($_POST['mb_1']) || !$_POST['mb_1']) {
    //     alert('회원가입 유형을 선택해주세요.', G5_BBS_URL.'/register.php');
    // }

    // if (!isset($_POST['agree']) || !$_POST['agree']) {
    //     alert('회원가입약관의 내용에 동의하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL.'/register_s.php');
    // }

    // if (!isset($_POST['agree2']) || !$_POST['agree2']) {
    //     alert('개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL.'/register_s.php');
    // }
...
$type  = isset($_REQUEST['type']) ? preg_replace('#[^0-9]#', '', $_REQUEST['type']) : '';
