...
<div class="register register_st_<?php echo $member['mb_1'] ?>">
...
<?php } ?>
	...
	<div id="register_form" class="form_01">   
        ...
        <div class="register_title_wrap <?php echo $member['mb_1'] ?>">
            <span>
                <?php if( $member['mb_1'] == "student") { ?>
                    학생가입
                <?php } else { ?>
                    인스트럭터가입
                <?php } ?>
            </span>
            <p><img src="<?php echo G5_URL?>/common/images/sub/register_tit_<?php echo $member['mb_1']?>.png" /></p>
        </div>
        ...
        <div class="regi_box">
            ...
            <div class="con">
                ...
                <ul class="regi_ipt_list">
                    <li>
                        <p class="t"><?php if($member['mb_1']=="student")echo "학생 "; ?>이름 <span class="im"></span></p>
                        <p class="ipt">
                            <input type="text" name="" value="" id="" class="iptSt01" placeholder="한글만 입력 가능" />
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p class="t"><?php if($member['mb_1']=="student")echo "학생 "; ?>아이디 <span class="im"></span></p>
                        <p class="ipt">
                            <input type="text" name="" value="" id="" class="iptSt01" placeholder="이메일주소를입력해주세요." />
                        </p>
                    </li>
                    <li>
                        <p class="t">비밀번호 <span class="im"></span></p>
                        <p class="ipt">
                            <input type="password" name="" value="" id="" class="iptSt01" placeholder="비밀번호 (8~32자)" />
                            <span class="color cc">입력 가능한 특수문자 !@#$%^&*)(-+=~`{}|\";':>_<],.[?/</span>
                        </p>
                    </li>
                    <li>
                        <p class="t">비밀번호 확인<span class="im"></span></p>
                        <p class="ipt">
                            <input type="password" name="" value="" id="" class="iptSt01" placeholder="비밀번호 재확인" />
                        </p>
                    </li>
                    <li>
                    ...
                    <li class="on">
                        <div class="t">
                            <div class="chkBox">
                                <label for="agree1">
                                    <div class="chkCont">
                                        <input type="checkbox" name="agree" id="agree1" class="chkInp" />
                                        <span class="chkBtn"></span>
                                    </div>
                                    이용약관 동의(필수)
                                </label>
                        ...
                        <div class="c">
                            <div class="in">
                    ...
                    <li class="">
                        <div class="t">
                            <div class="chkBox">
                                <label for="agree2">
                                    <div class="chkCont">
                                        <input type="checkbox" name="agree2" id="agree2" class="chkInp" />
                                        <span class="chkBtn"></span>
                                    </div>
