                ...
                <ul class="regi_ipt_list">
                    ...
                    <?php if($member['mb_level']=="1") { ?>
                        <li>
                            ...
                            <p class="ipt">
                                <select name="mb_1" id="mb_1" onchange="getTeamInfo(this.value)" class="iptSt01">
                                    <option>혁신단을 선택해주세요.</option>
								<?php
									$sql = "select * from g5_organize";
									$res = sql_query($sql);
									for ($i=0; $row=sql_fetch_array($res); $i++) {
								?>
                                    <option value="<?=$row['og_id']?>"><?=$row['og_name']?></option>
								<?php
                        ...
                        <li>
                            ...
                            <p class="ipt">
                                <select name="mb_2" id="mb_2" class="iptSt01">
                        ...
                        <li>
                            ...
                            <p class="ipt">
                                <select name="mb_3" id="mb_3" class="iptSt01">
                                    <option>역할을 선택해주세요.</option>
                    ...
                    <?php } else if($member['mb_level']=="5") { ?>
                        <li>
                            <p class="t">최종학력<span class="im"></span></p>
                            <p class="ipt">
                                <input type="text" name="mb_4" id="mb_4" class="iptSt01" placeholder="최종대학/최종학력 (ex - OO대학교 / OO학 O사)" />
                            </p>
                        </li>
                        <li>
                            <p class="t">소속<span class="im"></span></p>
                            <p class="ipt">
                                <input type="text" name="mb_5" id="mb_5" class="iptSt01" placeholder="소속회사명" />
                            </p>
                        </li>
                        <li>
                            <p class="t">직위<span class="im"></span></p>
                            <p class="ipt">
                                <input type="text" name="mb_6" id="mb_6" class="iptSt01" placeholder="직위" />
                            </p>
                        </li>
                    <?php } ?>
                    ...
                    <li class="on">
                        <div class="t">
                            <div class="chkBox">
                                <label for="agree11">
                                    <div class="chkCont">
                                        <input type="checkbox" name="agree" value="1"  id="agree11" class="chkInp" />
                                        <span class="chkBtn"></span>
                                    </div>
                                    이용약관 동의(필수)
                                </label>
                    ...
                    <li class="">
                        <div class="t">
                            <div class="chkBox">
                                <label for="agree21">
                                    <div class="chkCont">
                                        <input type="checkbox" name="agree2" id="agree21" value="1"  class="chkInp" />
                                        <span class="chkBtn"></span>
                                    </div>
