...
<div id="mb_login" class="mbskin">
    <div class="mbskin_box">
        ...
        <fieldset id="login_fs">
            ...
            <div class="mb_login_category">
                <div class="box">
                    <input type="radio" name="loginWho" id="loginStudent" value="loginStudent" checked="checked" />

                    <label for="loginStudent">학생 로그인</label>
                </div>
                <div class="box">
                    <input type="radio" name="loginWho" id="loginInstructor" value="loginInstructor" />

                    <label for="loginInstructor">인스트럭터 로그인</label>
                </div>
            </div>

            <label for="login_id" class="sound_only">회원아이디<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="mb_id" id="login_id" required class="frm_input required" placeholder="아이디" onMouseOver='chkReset(this.form);' onFocus='chkReset(this.form);' value='<?=$ck_id_save?>'>
            ...
            <div id="login_info">
                <div class="login_if_auto chk_box">
                    ...
                    <input type="checkbox" id="login_id_save" name="id_save" <?=$ch_id_save_chk?>>
                    <label for="login_id_save"><span></span>아이디 저장</label>
                </div>
            ...
            <button type="submit" class="btn_submit btn_logins">로그인</button>
            <!--<a href="<?php //echo G5_BBS_URL ?>/register.php" class="btn_register btn_logins">회원가입</a>-->

            <div class="login_banner"><a href="javascript:GoPage('bcb')"><img src="<?php echo G5_URL?>/common/images/sub/login_banner.png" alt="한국청년기업가정신재단" /></a></div>
        </fieldset>
        </form>
