	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <div class="cm_wrap">
            ...
            <header style="z-index:<?php echo $cmt_sv; ?>">
              ...
              <span class="na">
                <?php if($bo_table == "comm2" || $bo_table == "comm3"){ ?>
                    <?php if($list[$i]['wr_1'] == "2") { ?>
                      <b class="ic s">탐색팀</b>
                    <?php } elseif ($list[$i]['wr_1'] == "3") { ?>
                      <span class="na"><b class="ic i">인스트럭터</b>
                    <?php } elseif ($list[$i]['wr_3']=="10") {?>
                      <span class="na"><b class="ic g">관리자</b>
                    <?php } ?>
                <?php } ?>
	            ...
	            <span class="sound_only">(<?php echo $list[$i]['ip']; ?>)</span>
	            <?php } ?>
	            <span class="sound_only">작성일</span>
	            <span class="bo_vc_hdinfo"><i class="fa fa-clock-o" aria-hidden="true"></i> <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['datetime'])) ?>"><?php echo date("Y-m-d H:i:s", strtotime($list[$i]['datetime']))   ?></time></span>
	        ...
	        <div class="cmt_contents">
	            <p>
                <?php if (strstr($list[$i]['wr_option'], "secret")) { ?><span style="color:#2e63f6"><img src="<?php echo $board_skin_url; ?>/img/icon_secret.gif" alt="비밀글" style="vertical-align:middle"> 비밀글</span><?php } ?>
	                <?php echo $comment ?>
	            </p>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
        <div class="bo_vc_w_info">
          <input type="text" name="wr_1" value="<?php echo $member['mb_level']; ?>" id="wr_1" required class="frm_input required" size="25" placeholder="권한" style="display:none;">
            <?php if ($is_guest) { ?>
