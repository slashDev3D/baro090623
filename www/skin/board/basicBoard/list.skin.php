...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="basic_list_wrap">
        ...
        <div class="list_box <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
                ...
                <p class="liInfo">
                  <span class="na"><?php echo $list[$i]['name'] ?></span>
                  <span class="dot"></span><span><?php echo date("Y-m-d", strtotime($list[$i]['wr_datetime'])); ?></span>
                  <span class="dot"></span><span><?php echo $list[$i]['wr_hit']; ?>회</span>
                </p>
