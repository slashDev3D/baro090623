    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
            ...
            <?php if($bo_table == "comm2" || $bo_table == "comm3"){ ?>
              <li>
                <?php if($view['wr_1'] == "2") { ?>
                  <span class="tt">작성자</span><span class="na"><b class="ic s">탐색팀</b> <?php echo $view['name'] ?></span>
                <?php } elseif ($view['wr_1'] == "3") { ?>
                  <span class="tt">작성자</span><span class="na"><b class="ic i">인스트럭터</b> <?php echo $view['name'] ?></span>
                <?php } ?>
              </li>
            <?php } ?>
...
;
    ...
    <?php
    // 코멘트 입출력
    if($board['bo_comment_level'] != 10 || $is_admin) {
