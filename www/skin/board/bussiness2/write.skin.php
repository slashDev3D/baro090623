...
<section id="bo_w">
    ...
    <div class="write_div">
        <label for="wr_2" class="sound_only">영문팀명</label>
        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input half_input" size="50" placeholder="영문팀명">
    </div>

    <div class="write_div">
        <label for="wr_3" class="sound_only">간략소개</label>
        <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" class="frm_input half_input" size="50" placeholder="간략소개">
    </div>
