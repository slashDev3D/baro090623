    ...
    <div class="bo_sch_wrap">   
        <fieldset class="bo_sch">
            ...
            <div class="sch_box">
                ...
                <div class="sch_bar">
                    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" size="25" maxlength="20" placeholder="갤러리 검색하기">
                ...
                <div class="gall_con">
                        ...
                        <a href="<?php echo $list[$i]['href'];?>">
                            <?php
                                ...
                                <?php } else {
                                    ...
                                    if($thumb['src']) {
                                        $img_content = '<div class="img" style="background-image:url('.$thumb['ori'].')"></div>';
                                    } else {
                    ...
                    <div class="gall_text_wrap">
                        ...
                        <ul class="text_cont">
                            ...
                            <li class="dot"></li>
                            <li><?php echo "View ".$list[$i]['wr_hit']; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
