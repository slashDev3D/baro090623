    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	<ul  class="profile_info_ct ">
                <?php if($is_admin){ ?>
                    <li><span class="tt">작성자</span> <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong><br></li>
                    <li><span class="tt">댓글</span><strong><a href="#bo_vc"> <i class="fa fa-commenting-o" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong></li>
                <?php } ?>
        		<li><span class="tt">조회수</span><strong><?php echo number_format($view['wr_hit']) ?>회</strong></li>
        		<li><span class="tt">작성일</span><strong><?php echo date("Y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong></li>
    		</ul>
            <div class="profile_info_ct w100">
                <?php if($view['wr_1']){?><li><span class="tt"><?=$board[bo_1_subj]?></span> <strong><?php echo $view['wr_1'] ?></strong></li><?php } ?>
                <?php if($view['wr_2']){?><li><span class="tt"><?=$board[bo_2_subj]?></span> <strong><?php echo $view['wr_2'] ?></strong></li><?php } ?>
                <?php if($view['wr_3']){?><li><span class="tt"><?=$board[bo_3_subj]?></span> <strong><?php echo $view['wr_3'] ?></strong></li><?php } ?>
                <?php if($view['wr_4']){?><li><span class="tt"><?=$board[bo_4_subj]?></span> <strong><?php echo $view['wr_4'] ?></strong></li><?php } ?>
    		</div>
    	</div>
...
<script>
$(function(){
    $("#bo_v_img").find('.view_image').each(function(e){ // id bo_v_img 안의 이미지만 적용으로 변경
        ...
        vi.removeAttr('class');
        vi.attr('class', 'imgLink');
        vi.append(`<div class="btn-down"><a download="download_${e}.${ori_ext[e]}" href="${ori_img[e]}">다운로드</a></div>`);
    });
});
</script>
