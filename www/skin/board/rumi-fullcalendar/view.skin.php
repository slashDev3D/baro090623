    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
            <ul class="profile_info_ct">
                <li>
                    <span class="tt">진행기간</span>
                    <strong>
                        <?php
                            if ($view['wr_1'] == $view['wr_2']) {
                                echo '<span class="date-txt">'.date("Y.m.d H:i", strtotime($view['wr_1'])).'</span>';
                            }
                            else {
                                echo '<span class="date-txt">'.date("Y.m.d H:i", strtotime($view['wr_1'])).' ~ '.date("Y.m.d H:i", strtotime($view['wr_2'])).'</span>';
                            }
                        ?>
                    </strong>
                </li>
