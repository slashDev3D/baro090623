...
<ul id="bo_v_sns" class="<?php echo $bo_v_sns_class; ?>">
    ...
    <?php if($config['cf_kakao_js_apikey']) { ?>
    <li><a href="javascript:Kakao_sendLink();" class="sns_k" ><img src="<?php echo G5_SNS_URL; ?>/icon/kakaotalk.png" alt="카카오톡으로 보내기" width="20"> 카카오톡 공유</a></li>
    <?php } ?>

    <li>
        <a class="sns_c" onclick="copyToClipboard('#pp_view')">
            <i class="fa fa-clipboard" aria-hidden="true"></i>&nbsp;&nbsp;주소복사<span id="pp_view" style="display:none"><?php echo `http://`.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?></span>
        </a>
    </li>
</ul>
