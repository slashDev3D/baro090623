        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    ...
                    children.push(
                        createElement("button", __assign({ 
                            disabled: isDisabled, 
                            className: buttonClasses.join(' '), 
                            onClick: buttonClick, type: 'button' }, ariaAttrs), 
                ...
                createElement("div", { className: 'fc-daygrid-day-top', ref: innerElRef },
                   (props.date >= toDay) && createElement("i", __assign({ className: 'fa fa-pencil rumi-write' }, navLinkAttrs)),
                    ...
                    lunar.holiday ? createElement("div", __assign({ className: 'rumi-lunarholiday' }), lunar.holiday) : "",
                            createElement("div", __assign({ className: 'fc-daygrid-day-number' }, navLinkAttrs), innerContent))); }));  // a 로 변경시 일자로 접속가능 !
        };
        return TableCellTop;
    }(BaseComponent));
