...
<header id="hd">
    ...
    <div id="hd_top">
        ...
        <div id="tnb">
            <ul>
                ...
                <?php } ?>
                <li class="tnb_li"><a href="http://bcb.or.kr" class="tnb_bcb" target="_blank" title="BCB 바로가기">BCB</a></li>
                ...
                <li class="tnb_li"><button type="button" class="tnb_mb_btn">Manage<span class="./img/btn_gnb.png">메뉴열기</span></button>
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>" style="<?php if($member['mb_level']==3){ echo 'display:none'; }?>">
        <h2>관리자 주메뉴</h2>
        <ul class="gnb_ul">
            <?php
            $jj = 1;
...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>" style ="<?php if($member['mb_level']==3){ echo 'padding:0'; } ?>">

        <h1 id="container_title" style ="<?php if($member['mb_level']==3){ echo 'padding-left:20px'; } ?>"><?php echo $g5['title'] ?></h1>
